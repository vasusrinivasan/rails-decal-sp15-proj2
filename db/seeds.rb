...
comment = Comment.create(content: 'Hi!', food_id: 1, user_id: 1, user_name: 'Yoyo')

comment_again = Comment.create(content: 'I have arrived!', food_id: 1, user_id: 2, user_name: 'Hihi')

last_comment = Comment.create(content: 'No', food_id: 2, user_id: 3, user_name: 'Nono')

user = User.create(email: 'yoyo@yoyo.yoyo', password: 'yoyoyoyo', name: 'Yoyo')

user_again = User.create(email: 'hihi@hihi.hihi', password: 'hihihihi', name: 'Hihi')

last_user = User.create(email: 'nono@nono.nono', password: 'nononono', name: 'Nono')